...
export default function AdminQuizDetailsClient({ id }: { id: string }) {
    ...
    <div className="flex w-full flex-col">
      ...
      {coverUrl ? (
        <div className="w-full pt-1 pb-4">
          <div className="border-border/80 bg-muted/25 relative aspect-video overflow-hidden rounded-xl border">
            <Image
              src={coverUrl}
