    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Огонь, вода, земля и воздух выбираются в лобби и дают уникальные бонусы и недостатки. Любой исход может изменить очки. Без стихии остаются speed, серия и Lucky. После подтверждения участия один игрок случайно становится аватаром игры.",
          },
        },
        {
          "@type": "Question",
